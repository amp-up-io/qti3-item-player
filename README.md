...
See the [open issues](https://github.com/amp-up-io/qti3-item-player/issues) for a full list of proposed features (and known issues).
...
This component would not be possible were it not for a fortuitous decision by the aQTI working group - meeting in Arnhem, NE at CITO headquarters, January 2015 - to make QTI3 "web component friendly".  
