<template>
  <div ref="root" class="qti-template-inline hidden">
    <slot></slot>
  </div>
</template>
...
<script>
/*
 * This permits the insertion of template inline structures i.e. to identify template-based information.
 */
...
export default {
  ...
  props: {
    ...
    /*
     * [0..1] multiplicity
     * The showHide characteristic determines how the visibility of the qti-template-inline is controlled.
  ...
  methods: {
    ...
    evaluate () {
      try {
        ...
        console.log('[QtiTemplateInline][' + this.templateIdentifier + '][Show]', this.show)
...
<style>
div.qti-template-inline {
  display: inline-block;
}

div.qti-template-inline.hidden {
  display: none;
}
</style>
